	...
	<div class="row bg-title">
		...
		<div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
			<ol class="breadcrumb">
				...
				<li><a href="<?php echo addFullUrl(array('add'=>0,'edit'=>0,'delete'=>0))?>" class="li_active"><?php echo $page_title?> (<?php echo $data_info[$Name]?>)</a></li>
					...
					<table class="table table-striped">
						...
						while($row=mysqli_fetch_assoc($sql))
						{
							if($row["image"]!=""){
								...
								$image='<a href="'.$row["video_url"].'" target="_blank" style="font-size:16px;">Video</a>';
