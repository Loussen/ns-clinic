					...
					<table class="table table-striped">
						...
						while($row=mysqli_fetch_assoc($sql))
						{
							echo '<tr>
									...
									<td><iframe width="300" height="200" src="https://www.youtube.com/embed/'.youtube_embed($row['video_url']).'" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></td>
