...
<form action="" method="post" enctype="multipart/form-data" class="<?php echo $hideForm?>">
	<div class="tab-content">
		...
		<div class="form-group row">
			...
			<div class="col-md-10">
				<select name="category_id[]" class="form-control select2" multiple>
					...
					<?php
					$selecteds=explode("-",$information["category_id"]);
					$sql=mysqli_query($db,"select id,$Name from categories2 order by position");
					while($row=mysqli_fetch_assoc($sql)){
						if(in_array($row["id"],$selecteds)) $selected='selected="selected"'; else $selected='';
		...
		?>
		<div class="form-group row">
			<label for="example-text-input" class="col-md-2 col-form-label">Şəkil (600x600):</label>
			<div class="col-md-10">
		...
		<div class="form-group row">
			<label for="example-text-input" class="col-md-2 col-form-label">New:</label>
			<div class="col-md-10">
