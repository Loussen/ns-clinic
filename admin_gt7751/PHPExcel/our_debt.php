...
$yeast_price_converted=0;
$yeast_payed_amount=0;
$yeast_not_payed_amount=0;
...
while($row=mysqli_fetch_assoc($sql))
{
	...
	if($row["currency_id"]!=1) $converted=' ('.$row["yeast_price_converted"].' AZN)'; else $converted='';
	...
	$yeast_price_converted+=$row["yeast_price_converted"];
	$yeast_payed_amount+=$row["yeast_payed_amount"];
	$yeast_not_payed_amount+=$row["yeast_not_payed_amount"];
...
$excel2->getActiveSheet()
	...
	->setCellValue('E'.$sirasi, $yeast_price_converted.' AZN' )
	->setCellValue('F'.$sirasi, $yeast_payed_amount.' AZN' )
	->setCellValue('G'.$sirasi, $yeast_not_payed_amount.' AZN' )
