	                    ...
	                    <div class="col-md-6 col-lg-4 tm-animation move-up">
		                    <div class="tm-sc-iconbox iconbox-style-current-theme mediku-department icon-box animate-icon-on-hover animate-icon-rotate-y mb-30">
			                    <div class="icon-wrapper">
				                    <div class="icon">
					                    <img class="icon-img" src="<?= SITE_PATH ?>/images/services/<?= $row['image'] ?>"
			                    ...
			                    <div class="content text-center">
				                    ...
				                    <a class="btn-plain-text-with-arrow" href="<?= $site ?>/xidmet/<?= slugGenerator($row['name_' . $lang_name]) . '-' . $row["id"] ?>"><?=$lang23?></a>
			                    </div>
		                    </div>
	                    </div>
						<?php
