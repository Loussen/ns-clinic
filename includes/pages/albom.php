				...
				<div class="col-lg-4 col-sm-6 class_<?=$row_photos['parent_id']?>">
					<div class="gallery-item-two mt-30">
						<div class="gallery-thumbnail">
							<img src="<?=SITE_PATH?>/images/photo_albums_gallery/<?=$info_album['id']."/thumb_".$row_photos['image']?>" alt="<?=$info_album['name_'.$lang_name]?>">
						</div>
						<div class="gallery-caption">
							<div>
								<a href="<?=SITE_PATH?>/images/photo_albums_gallery/<?=$info_album['id']."/".$row_photos['image']?>" class="plus-icon"><i class="far fa-plus"></i></a>
